...
namespace analizadorLexico
{
    ...
    class MiniCompilador
    {
        ...
        public void cargarMatriz()
        {
            ...
            String[] lineas = File.ReadAllLines(@"A:\UDG\Trabajos\5to Semestre\Seminario de Traductores 2\Proyecto Final\Prototipo 1\Generacion de Codigo\xs.lr", Encoding.Default);
        ...
        public void cargarReglas()
        {
            int delimitador = 9;
            char _dem = Convert.ToChar(delimitador);
            string[] lineas = File.ReadAllLines(@"A:\UDG\Trabajos\5to Semestre\Seminario de Traductores 2\Proyecto Final\Prototipo 1\Generacion de Codigo\rl.txt", Encoding.Default);
